 ...
 * @author ASUS
 */
public class updateServiceTicketMechanicServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean status = d.updateServiceTicket(serviceTicketID, serviceID, hours, comment, rate);
            
            request.setAttribute("status", status);
            request.setAttribute("detail", d.getServiceMechanicByServiceTicketId(serviceTicketID));
